...
| `products`    | [`Product`] array | The `Product` array associated with the Fast Checkout. Refer to [Product Object Breakdown](#product-option-breakdown) for more details. |
...
| `productOptions`    | [`ProductOption`] array | Configurable properties of this Product (e.g. color, size, etc.). |
...
Currently the SDK can support dark or light mode as set at the system level, but does not currently support manually toggling the theme using the SDK.

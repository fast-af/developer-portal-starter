...
| `SDKClosed`      | Buyer has exited the Fast Android SDK                                                                                                                                                                                                           | None Required (but can return `PurchaseInfo`) |
...
| -------------------------------- | -------------- | --------------------------------------------- |
| `FastCheckoutEvent.purchaseInfo` | `PurchaseInfo` | Additional relevant data regarding the event. |

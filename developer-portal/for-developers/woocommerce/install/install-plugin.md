...
2. In a new window (i.e. keep the WordPress admin dashboard open in a separate window) go to the [Fast Seller Dashboard](https://www.fast.co/business/dash/install) and copy the App ID (`app_id`) you see there to your clipboard.

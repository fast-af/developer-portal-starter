...
<Alert variant="attention" header="Custom Cartridge ZIP File">
  {" "}
  If needed, a Fast team member can also provide the cartridge as a ZIP file incorporating
  the <Link to="../pre-install/requirements.md">
...
>
  This method will require setting up a <code>dw.json</code> file to connect to
  your site.
</Alert>

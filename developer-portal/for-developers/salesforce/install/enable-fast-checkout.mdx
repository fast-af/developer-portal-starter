...
3. Once the code has been added, navigate to Prophet Debugger (similar to when you [first added the Fast cartridge](./acquire-extension.mdx#option-2-using-the-prophet-debugger-visual-studio-code-extension)), and click the **Upload** button to upload all of the updated files.

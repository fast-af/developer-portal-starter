...
6. **Add Fast API Client** in Account Manager
   ...
   - The API Client ID and Password produced during this step will be used by your Fast Delivery Team to generate a Fast App ID (`app_id`) for your store.
     ...
     - Set **Fast App ID**
       - Enter the Sandbox App ID (`app_id`) provided to you previously by Fast
         <Alert
           ...
           content='You must first complete the "Add Fast API Client" step above so that the Fast Delivery Team can generate a Fast App ID (or Sandbox App ID, as approriate) for your store.'
         />

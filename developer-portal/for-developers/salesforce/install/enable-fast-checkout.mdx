...
1. Navigate to **Administration > Users**.
   - If you have the proper permissions you will see a **Create Users** button here.
...
3. Once the code has been added, navigate to your Prophet Debugger (similar to when you [first added the Fast cartridge](./acquire-extension.md#option-2-using-the-prophet-debugger-visual-studio-code-extension)), and click the **Upload** button to upload all of the updated files.
...
4. The following video section also demonstrates how to insert the custom code necessary to display the Fast Checkout button for your storefront:
   ...
   <YouTubeVideoEmbed
     ...
     videoTitle="Add the Fast Buttont to the Storefront Code"
   />

...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    ...
    <ThinTile
      to="https://updates.fastdevs.co/"
      icon={updates}
      header="Product Updates"
    >
      Stay in-the-know with Fast products and receive product updates in your
      inbox.
    </ThinTile>
  </FlexSection>
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile
      to="https://twitter.com/Fast_Devs"
      icon={twitter}
      header="Fast Devs on Twitter"
    >
